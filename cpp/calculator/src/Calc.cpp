...
double Calc::process(std::string userInput, double prevValue) { //TODO: consider how to handle other non-number characters.
    ...
    if(cleansedString[0] == '^') {
        ...
        if(cleansedString[0] == '*') {
            ...
            if(value == 0) {
                std::exit(0); //TODO: consider extended error code handling.
            } else {
                return prevValue / value;
            }
        }
